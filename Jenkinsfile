pipeline {
  ...
  environment {
    ...
    BUILD_VERSION_ARG = 'CODE_VERSION'
    LS_USER = 'linuxserver'
    LS_REPO = 'docker-vscode'
    CONTAINER_NAME = 'vscode'
    DOCKERHUB_IMAGE = 'linuxserver/vscode'
    DEV_DOCKERHUB_IMAGE = 'lsiodev/vscode'
    PR_DOCKERHUB_IMAGE = 'lspipepr/vscode'
    DIST_IMAGE = 'debian'
    MULTIARCH = 'true'
    CI = 'true'
    CI_WEB = 'true'
  ...
  stages {
    ...
    stage("Set tag custom bash"){
      steps{
        script{
          env.EXT_RELEASE = sh(
            script: ''' curl -sL https://update.code.visualstudio.com/api/releases/stable | awk -F'"' '{print $2}'
 ''',
            returnStdout: true).trim()
    ...
    stage('Build-Single') {
      ...
      steps {
        ...
        sh "docker buildx build \
          ...
          --label \"org.opencontainers.image.url=https://github.com/linuxserver/docker-vscode/packages\" \
          --label \"org.opencontainers.image.documentation=https://docs.linuxserver.io/images/docker-vscode\" \
          --label \"org.opencontainers.image.source=https://github.com/linuxserver/docker-vscode\" \
          --label \"org.opencontainers.image.version=${EXT_RELEASE_CLEAN}-ls${LS_TAG_NUMBER}\" \
          --label \"org.opencontainers.image.revision=${COMMIT_SHA}\" \
          --label \"org.opencontainers.image.vendor=linuxserver.io\" \
          --label \"org.opencontainers.image.licenses=GPL-3.0-only\" \
          --label \"org.opencontainers.image.ref.name=${COMMIT_SHA}\" \
          --label \"org.opencontainers.image.title=Vscode\" \
          --label \"org.opencontainers.image.description=[VS Code](https://code.visualstudio.com/) is an integrated development environment developed by Microsoft. This container runs the full desktop application, for a web native version see [Code Server](https://github.com/linuxserver/docker-code-server).\" \
